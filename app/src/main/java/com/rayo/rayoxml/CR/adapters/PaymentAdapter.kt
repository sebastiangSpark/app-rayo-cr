...
import com.rayo.rayoxml.cr.services.Auth.Pago
...
class PaymentAdapter(private val paymentList: MutableList<Pago>) :
    ...
    override fun onBindViewHolder(holder: PaymentViewHolder, position: Int) {
        ...
        holder.installmentAmount.text = "$currencySymbol${formatter.format(payment.montoPagar.toDouble())}"
        ...
        when (payment.estado) {
            ...
            "En Revisión" -> {
                holder.installmentStatusImage.setImageResource(R.drawable.ic_pending_detail)
            }
            "En mora" -> {
