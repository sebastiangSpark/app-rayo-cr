...
class CivilStateAdapter(private val onItemClick: (String) -> Unit) : RecyclerView.Adapter<CivilStateAdapter.ViewHolder>() {

    private val items = listOf("Soltero", "Casado", "Viudo", "Divorciado", "Unión Libre")
