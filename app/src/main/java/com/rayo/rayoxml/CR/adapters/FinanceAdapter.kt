...
fun createFinanceItems(): List<FinanceItem> = listOf(
    FinanceItem(
        ...
        "https://rayo.cr/blog/que-son-los-mini-prestamos"
    ),
    FinanceItem(
        ...
        "https://rayo.cr/blog/mini-prestamos-a-empleados"
    ),
    // Agrega más items aquí
    FinanceItem(
        "Summit Fintech en Costa Rica",
        "El pasado 28 de agosto se llevó a cabo en San José de Costa Rica el Summit Fintech organizado por ASOCOMI - Asociación Costarricense de Microfinanzas y la CAMTIC ....",
        R.drawable.summit_fintech,
        "https://rayo.cr/blog/buscando-un-mini-prestamo-facil"
    )
)