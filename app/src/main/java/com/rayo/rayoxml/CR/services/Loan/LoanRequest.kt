...
data class CreateLoanRequest(
    ...
    val fechaExpiracionCedula: String,
    val genero: String,
    val cuentaOrderPatronal: String,
    var cuentaIBAN: String,
    val moneda: String,
    val pais: String,
    ...
    val fidelidad: String,
    val actividadEconomica: String,
    val profesion: String,
    val referido: String,
    val referidoNombre: String? = "",
    val referidoCedula: String? = "",
    val password: String,
    val partner: String? = "",
    val clickid: String? = "",
    ...
    val plazo: String,
    val cuentaOrdenPatronal: String,
    val estado: String
)

data class CompleteLoanRequest(
    val Id: String,
...
data class CreateLoanMiniRenewalRequest(
    val id: String // id contacto
)

data class CompleteLoanMiniRenewalRequest(
    val Id: String,
    val checkTecnologia: Boolean,
    val plazo: Int,
    val requirioAyuda: String,
    val ordenPatronalContentType: String,
    val ordenPatronalName: String,
    val ordenPatronal: String
)

data class CreateLoanRpRenewalRequest(
    val Id: String,
    val checkTecnologia: Boolean,
    val plazo: String,
    val montoSolicitado: String
...
data class CompleteLoanRpRenewalRequest(
    val Id: String,
    val requirioAyuda: String,
    val ordenPatronalContentType: String,
    val ordenPatronalName: String,
