...
class DistritoAdapter(
    private val items: List<String>,
    private val onItemClick: (String) -> Unit) : RecyclerView.Adapter<DistritoAdapter.ViewHolder>() {

    //private val items = listOf("Paraíso", "Santiago", "Orosi", "Cachí", "Llanos de Santa Lucía")
