...
data class OpcionRespuesta(
    @SerializedName("IdRespuesta") val idRespuesta: String,
    @SerializedName("respuesta") val respuesta: String
)

data class Pregunta(
    @SerializedName("IdPregunta") val idPregunta: String,
    @SerializedName("pregunta") val pregunta: String,
    @SerializedName("ordenPregunta") val ordenPregunta: String,
    @SerializedName("respuestas") val respuestas: List<OpcionRespuesta>
)
