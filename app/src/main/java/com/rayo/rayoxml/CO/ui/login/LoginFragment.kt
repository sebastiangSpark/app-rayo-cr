package com.rayo.rayoxml.co.ui.login
...
import com.rayo.rayoxml.co.services.Auth.AuthRepository
...
import com.rayo.rayoxml.utils.hideKeyboard
...
class LoginFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupPasswordToggle()
        binding.loginEmailEditText.setOnClickListener { it.requestFocus() }
        binding.loginPasswordEditText.setOnClickListener { it.requestFocus() }

    }


    private fun goToHome() {
        /*val sharedPreferences = requireActivity().getSharedPreferences("userData", android.content.Context.MODE_PRIVATE)
    ...
    private fun login(){
        ...
        lifecycleScope.launch {
            ...
            if (loginResponse != null && loginResponse.solicitud?.acceso == "aceptado") {
                // ✅ Inicio de sesión exitoso
                emailEditText.background = ContextCompat.getDrawable(requireContext(), R.drawable.custom_input_background)
                passwordEditText.background = ContextCompat.getDrawable(requireContext(), R.drawable.custom_input_background)

                if (loginResponse.solicitud.contacto != null) {
                    viewModel.getData(loginResponse.solicitud.contacto)
                }
                ...
                errorPasswordTextView.text = "Contraseña inválida"
                errorPasswordTextView.visibility = View.VISIBLE
            }
        }
