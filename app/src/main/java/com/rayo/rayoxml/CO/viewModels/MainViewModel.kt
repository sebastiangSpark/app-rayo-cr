...
class MainViewModel : ViewModel() {
    ...
    fun updateToolbarVisibility(destinationId: Int) {
        val visibilityMap = when (destinationId) {
            ...
            R.id.recoverPasswordFragment,R.id.disbursementApprovalFragment, R.id.selectCountryFragment, R.id.UserVerifyFragment, R.id.preguntasFragment -> mapOf(
            ...
            R.id.benefitFragment,R.id.friendFragment,R.id.goodFriendFragment,R.id.bestFriendFragment,R.id.superFriendFragment -> mapOf(
                "toolbarMenu" to false,
                "toolbarProfile" to false,
                "toolbarDisbursement" to false,
                "toolbarPersonalProfile" to false,
