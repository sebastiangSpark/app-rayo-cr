...
import com.rayo.rayoxml.co.ui.dialogs.AvatarBottomSheetDialog
...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonChangeImage.setOnClickListener {
            val bottomSheet = AvatarBottomSheetDialog(
                currentSelection = authViewModel.selectedImage.value,
                onImageSelected = { selectedImage ->
                    lifecycleScope.launch {
                        authViewModel.saveSelectedImage(selectedImage)
                        updateToolbarImage(selectedImage)
                    }
                }
            )
