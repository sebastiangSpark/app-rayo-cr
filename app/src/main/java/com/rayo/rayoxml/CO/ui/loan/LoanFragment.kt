...
//                findNavController().navigate(R.id.selectCountryFragment)
    ...
    private fun loadData(){
       ...
       try {
           ...
           seekbarMinValue.text = "$" + formatter.format(minValue)
           seekbarMaxValue.text = "$" + formatter.format(maxValue)
           ...
           val seekBarChangeListener = object : SeekBar.OnSeekBarChangeListener {
               override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                   ...
                   textView.text = "$$formattedValue"  // Example: $10,000
    ...
    private fun setCreditData(creditValue: Int, term: Int){
        ...
        Log.d("LoanFragment", "realTerm: $realTerm")
        ...
        // Fianza
        val fianzaField: TextView = binding.root.findViewById<TextView>(R.id.bond_value)
