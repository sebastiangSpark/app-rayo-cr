...
class ViaAlterAdapter(private val onItemClick: (String) -> Unit) : RecyclerView.Adapter<ViaAlterAdapter.ViewHolder>() {

    private val items = listOf("#", "Autopista", "Avenida", "Avenida Calle", "Avenida Carrera", "Boulevar")
