...
class ViaAdapter(private val onItemClick: (String) -> Unit) : RecyclerView.Adapter<ViaAdapter.ViewHolder>() {

    private val items = listOf("Autopista", "Avenida", "Avenida Calle", "Avenida Carrera", "Boulevar", "Calle")
